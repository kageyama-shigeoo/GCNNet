...
parser = argparse.ArgumentParser(description='GCNNet inference on KITTI')
...
if args.dataset_split_file == '':
    DATASET_SPLIT_FILE = 'dataset/kitti/3DOP_splits/val.txt'
...
if VISUALIZATION_LEVEL == 1:
    print("Configure the viewpoint as you want and close the open3d tab to change the image")
